...
class Dataset_MYDATA(Dataset):
    ...
    def __read_data__(self):
        ...
        train_s, train_e = global_regions["train"]
        val_s, val_e = global_regions["val"]
        test_s, test_e = global_regions["test"]

        print("Row counts:")
        print(f"Train rows: {train_e - train_s}")
        print(f"Val rows:   {val_e - val_s}")
        print(f"Test rows:  {test_e - test_s}")
